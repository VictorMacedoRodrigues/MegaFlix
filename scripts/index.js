...
function eventListInicio() {
    iniciobtn === null || iniciobtn === void 0 ? void 0 : iniciobtn.addEventListener("click", inicio);
}
function eventListFilmes() {
    filmesbtn === null || filmesbtn === void 0 ? void 0 : filmesbtn.addEventListener("click", filmes);
}
function eventListSeries() {
    seriesbtn === null || seriesbtn === void 0 ? void 0 : seriesbtn.addEventListener("click", series);
}
function eventListFavoritos() {
    favoritosbtn === null || favoritosbtn === void 0 ? void 0 : favoritosbtn.addEventListener("click", favoritos);
}
function eventListAcao() {
    acaobtn === null || acaobtn === void 0 ? void 0 : acaobtn.addEventListener("click", acao);
}
function eventListAventura() {
    aventurabtn === null || aventurabtn === void 0 ? void 0 : aventurabtn.addEventListener("click", aventura);
}
function eventListComedia() {
    comediabtn === null || comediabtn === void 0 ? void 0 : comediabtn.addEventListener("click", comedia);
}
function eventListDrama() {
    dramabtn === null || dramabtn === void 0 ? void 0 : dramabtn.addEventListener("click", drama);
}
function eventListFiccao() {
    ficcaobtn === null || ficcaobtn === void 0 ? void 0 : ficcaobtn.addEventListener("click", ficcao);
}
function eventListPolicial() {
    policialbtn === null || policialbtn === void 0 ? void 0 : policialbtn.addEventListener("click", policial);
}
function eventListRomance() {
    romancebtn === null || romancebtn === void 0 ? void 0 : romancebtn.addEventListener("click", romance);
}
function eventListSuspense() {
    suspensebtn === null || suspensebtn === void 0 ? void 0 : suspensebtn.addEventListener("click", suspense);
}
function eventListpesquisar() {
    botaopesquisa === null || botaopesquisa === void 0 ? void 0 : botaopesquisa.addEventListener("click", filtrodefilmes);
}
function filtrodefilmes() {
    let oqAPessoaDigitou = filtropesquisa.value;
